...
class ProductionAgent(BaseAgent):
    ...
    def _load_knowledge(self) -> str:
        p = Path(__file__).parent.parent / "knowledge" / "production_data.md"
        if p.exists():
...
MWIPLOTHIS: Lot 이력 트랜잭션 (실시간 생산 모니터링)
MWIPNWKSTS: 비가동 현황 (라인별 비가동 시간/사유)
...
IWIPORDSTS: 수주 인터페이스 (SO_NO, CUSTOMER_CODE, ORD_END_TIME=납기, IF_SQ)
MADMALMHIS: 설비알람 (ALARM_LEVEL, ACK_FLAG)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[학습된 MES 데이터 — knowledge/production_data.md 참조]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
